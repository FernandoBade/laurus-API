...
export const criarUsuarioSchema = z.object({
    ...
    email: z.string().toLowerCase().trim().email({ message: 'O e-mail deve ser um endereço de e-mail válido.' }),
    ...
    aparencia: z.enum([Aparencia.DARK, Aparencia.LIGHT], { message: 'A aparência deve ser "dark" ou "light".' }),
...
export const atualizarUsuarioSchema = z.object({
    ...
    aparencia: z.enum([Aparencia.DARK, Aparencia.LIGHT], { message: 'A aparência deve ser "dark" ou "light".' }).optional(),
